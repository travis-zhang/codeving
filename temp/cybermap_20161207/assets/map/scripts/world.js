...
(function() {
    ...
    GTW.World = (function() {
        ...
        function World() {
            ...
            // todo moveGeoIP to a better place
            // use geoip endpoint or just a canned json if not live
            var geoip_url = (location.host.match(/cybermap.kaspersky.com/)) ? '/geoip' : GTW.resource_url('data/geoip.json');
            ...
            GTW.load_resources({
                ...
                self.countries = resources.map.countries;
                self.geoip = (function() {
                    if (!resources.geoip)
                        return null;

                    var iso2 = resources.geoip.country;
                    var coord = resources.geoip.coord;
        ...
        World.prototype.draw = function(env) {
            ...
            if (USE_MAP) {
                ...
                _.each(this.countries, function(c, index) {
